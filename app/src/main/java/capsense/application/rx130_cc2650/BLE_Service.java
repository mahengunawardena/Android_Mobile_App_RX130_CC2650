...
public class BLE_Service extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "capsense.application.capsense.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "capsense.application.capsense.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "capsense.application.capsense.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "capsense.application.capsense.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "capsense.application.capsense.EXTRA_DATA";
    public final static String ACTION_WRITE_SUCCESS =
            "capsense.application.capsense.ACTION_WRITE_SUCCESS";

    // Intent extras
    public final static String EXTRA_GREEN =
            "capsense.application.capsense.EXTRA_GREEN";
    public final static String EXTRA_YELLOW =
            "capsense.application.capsense.EXTRA_YELLOW";
    public final static String EXTRA_RED =
            "capsense.application.capsense.EXTRA_RED";
    public final static String EXTRA_SOUND =
            "capsense.application.capsense.EXTRA_SOUND";
    public final static String EXTRA_LIGHT =
            "capsense.application.capsense.EXTRA_LIGHT";
    public final static String EXTRA_NOTIFICATION =
            "capsense.application.capsense.EXTRA_NOTIFICATION";
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                ...
                Log.e(TAG, "BluetoothManager Initialized.");
            }
        }
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
         ...
         */
        private void enableLimitNotifications(BluetoothGatt gatt) {
            // Loop through the characteristics for the button service
            for (BluetoothGattCharacteristic characteristic : gatt.getService(UUID.fromString(capsenseAttribute.RX130_CC2650_SERVICE)).getCharacteristics()) {
    ...
    private void broadcastUpdate(final String action,
        ...
        if ((UUID.fromString(capsenseAttribute.GREEN_LED)).equals(characteristic.getUuid())) {
            //  Seeking the new GREEN value, Add id, get request and broadcast
            intent.putExtra(EXTRA_GREEN, characteristic.getValue());
        } else if ((UUID.fromString(capsenseAttribute.YELLOW_LED)).equals(characteristic.getUuid())) {
            //  Seeking the new YELLO value, Add id, get request and broadcast
            intent.putExtra(EXTRA_YELLOW, characteristic.getValue());
        } else if ((UUID.fromString(capsenseAttribute.RED_LED)).equals(characteristic.getUuid())) {
            //  Seeking the new RED value, Add id, get request and broadcast
            intent.putExtra(EXTRA_RED, characteristic.getValue());
        } else if ((UUID.fromString(capsenseAttribute.LED_CHANGE)).equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(EXTRA_NOTIFICATION, stringBuilder.toString());
            }
        }
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        if ((characteristicQueue.size() <= 1)) {
            ...
            Log.w(TAG, "readCharacteristic & characteristic value : " + characteristic.getValue());
        }
        //mBluetoothGatt.readCharacteristic(characteristic);
    }
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        BluetoothGattDescriptor descriptor = characteristic.getDescriptor(capsenseAttribute.UUID_CHARACTERISTIC_UPDATE_NOTIFICATION_DESCRIPTOR);
